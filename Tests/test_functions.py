...
from Calculations.functions import (is_palindrome, fibonacci, count_vowels,
                                    calculate_discount, flatten_list,
                                    word_frequencies, is_prime)
...
def test_word_frequencies():
    assert word_frequencies("To be or not to be") == {"to": 2, "be": 2,
                                                      "or": 1, "not": 1}
    ...
    assert word_frequencies("Ala ma kota, a kot ma Ale.") == oczekiwany_wynik
