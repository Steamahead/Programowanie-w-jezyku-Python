...
class Book:
    ...
    def __str__(self):
        return f'Autor: {self.author_name} {self.author_surname}, Własność: {self.library}'
...
# Employees
e1 = Employee("Adam", "Nowak", '2020', '1990', "Warszawa", "Miła", "03-193", '111002003')
e2 = Employee("Anna", "Nowak", "2021", "1992", "Kraków", "Y", "3030", "666666666")
e3 = Employee("Tomasz", "Zając", "2022", "1995", "Gdańsk", "Z", "8080", "777777777")
